...
const Hero = () => {
     ...
     useEffect(() => {
          const handleScroll = () => {
               ...
               setYPos(window.scrollY * 0.2); // Adjust the division for desired effect
          };
          ...
          >
               <SwiperSlide className="relative flex flex-col justify-center h-full w-full">
                    <div className="flex md:flex-row flex-col justify-center items-center md:items-end h-full w-full bg-opacity-50 container p-2 mx-auto">
                         <div className="flex-1 flex items-center h-full md:w-1/2 mt-60 mb-10 md:mt-0 md:mb-0">
                              <div className="text-black">
                                   <h1 className="text-4xl lg:text-6xl mb-4 font-bold">
                                        Body Care
                                   </h1>
                                   <p className="text-sm md:text-lg max-w-lg leading-loose">
                         ...
                         <img src="/hero.png" className="bottom-0 left-0 md:w-1/2 h-full object-contain flex-1" />
                    </div>
               </SwiperSlide>
