...
const About = () => {
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>About Us | Ice Investment Nig Ltd</title>
      </Helmet>
      <NavWithContent
        title="About Us"
      ...
      <AboutPortfolio />
      <AboutManagement title="Management Team" teams={managementTeam} />
      <AboutManagement title="Marketing Team" teams={marketingTeam} />
    </>
  );
};
